...
public:
  ...
  ourvector(ourvector&& other)
  {
    ...
    //
    // clear the display_data members of the other vector since we now own the display_data:
    //
    other.A = nullptr;
    other.Size = 0;
    other.Capacity = 0;
    ...
    //
    // done, this vector now contains the display_data from the other vector, and
  ...
  ourvector& operator=(ourvector&& other)
  {
    ...
    //
    // now move the *other* display_data to this vector:
    //
    this->A = other.A;
    this->Size = other.Size;
    this->Capacity = other.Capacity;
    ...
    //
    // done, this vector now owns the display_data from the *other* vector:
    //
    return *this;  // we have to return a vector based on how = works:
  }
  ...
  void push_back(T e)
  {
    ...
    if (Size == Capacity)
    {
      ...
      // now delete A, and update private display_data members to point to new array
  ...
  // to iterate through various display_data structures in an abstract way.
  //
  iterator begin()
  {
  ...
  // iterate through various display_data structures in an abstract way.
  //
  iterator end()
  {
